...

{
  ...
  tensorflow2-rocm = python37Packages.callPackage ./development/libraries/tensorflow/2 {
    inherit (self) hcc hcc-unwrapped hcc-clang hcc-clang-unwrapped hip hipcub miopen-hip miopengemm rocrand rocprim rocfft rocblas rocr rccl cxlactivitylogger hip-clang;
    #clang-unwrapped = pkgs.llvmPackages_10.clang-unwrapped;
